...
(function() {
  ...
  function Sitelist(sites) {
    ...
    this.sites = sites || {
      ...
      "bild": { name: "Bild", url: "https://bild.de", controller: "BildDeController.js" },
      ...
      "disneyplus": { name: "Disney Plus", url: "https://www.disneyplus.com", controller: "DisneyPlusController.js" },
      ...
      "LBRY": { name: "LBRY", url: "https://beta.lbry.tv", controller: "LBRYController.js", alias: ["beta.lbry"] },
      ...
      "wefunkradio": { name: "WeFunkRadio", url: "http://www.wefunkradio.com", controller: "WeFunkRadioController.js" },
      "youtube": { name: "YouTube", url: "http://www.youtube.com" },
      "youzeek": { name: "YOUZEEK", url: "http://www.youzeek.com" },
      "zdf": { name: "ZDF", url: "https://zdf.de", controller: "ZdfDeController.js" },
